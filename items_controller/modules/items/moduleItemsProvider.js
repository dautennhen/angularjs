 ...
 angular.module('moduleItems', ['ngRoute', 'ui.router', 'db', 'moduleBase']);
 angular.module('moduleItems').controller('ItemsController', function ($scope, dbAction, moduleItems, $stateParams, $timeout, $routeParams, $window) {
	...
	angular.module('moduleItems').controller('ItemController', function ($scope, $stateParams) {
