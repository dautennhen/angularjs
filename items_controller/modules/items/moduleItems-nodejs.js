 ...
 angular.module('moduleItems', ['ngRoute', 'ui.router', 'db', 'moduleBase', 'moduleTable', 'bw.paging']);
 angular.module('moduleItems').controller('ItemsController', function ($log, $scope, dbAction, indexedDb, moduleItems, $stateParams, $timeout, $routeParams, $window, moduleTable) {
  ...
  //indexedDb
  //indexedDb.openConection(function(){
//	  indexedDb.insert({table:'ln', values:{name:'myname21', age : 18111}})  
 // });
 
  /*$timeout(function() {
	  indexedDb.insert({table:'lnne', values:{name:'myname21', age : 18111}})  
  }, 1000)*/
